<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-xl font-extrabold" style="color: #051e34;">Contas Bancárias</h1>
            <p class="text-sm mt-0.5" style="color: #87c2c0;">Gerencie suas contas para recebimento de saques.</p>
        </div>
        <button
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4"
            ...
            <div class="bg-white rounded-3xl p-6 w-full max-w-lg shadow-2xl">
                ...
                <div class="flex items-center justify-between mb-6">
                    <h3 class="font-extrabold text-lg" style="color: #051e34;">
                        {{ $editingId ? 'Editar conta' : 'Nova conta bancária' }}
                    </h3>
                    <button wire:click="resetForm()"
                            class="w-8 h-8 rounded-xl flex items-center justify-center hover:bg-gray-100"
                ...
                <div class="grid grid-cols-2 gap-3 mb-5">
                    <button wire:click="$set('type', 'pix')"
                            class="p-4 rounded-2xl text-sm font-bold transition text-center"
