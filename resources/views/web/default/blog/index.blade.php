...
<div class="voyage-article">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20">
        ...
        {{-- Hero --}}
        <div class="max-w-2xl mx-auto text-center mb-14 sm:mb-16 fade-up">
            <span class="eyebrow-tag text-xs" style="color: var(--teal-deep);">
                DIÁRIO DE BORDO
            </span>
            <h1 class="display text-4xl sm:text-5xl font-medium leading-[1.1] mt-4 mb-5" style="color: var(--ink);">
                Blog
            </h1>
            <p class="text-base sm:text-lg" style="color: var(--ink-soft);">
                Dicas, novidades e conteúdos para você aproveitar melhor a sua experiência.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            @empty
                <div class="col-span-full py-20 text-center rounded-2xl" style="border: 2px dashed var(--line);">
                    <p style="color: var(--ink-soft);">Nenhum artigo publicado no momento.</p>
                </div>
            @endforelse
        </div>
...
<style>
    ...
    .voyage-page-btn.is-dots {
        border: none;
        background: transparent;
        color: var(--ink-soft);
    }
    .voyage-page-btn.is-disabled {
        opacity: .35;
        cursor: not-allowed;
    }
