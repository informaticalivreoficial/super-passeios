                    ...
                    <ul class="space-y-3 text-sm" style="color: #b8d4e8;">
                        ...
                        @if($config->cell_phone)
                            <li class="flex items-center gap-3">
                                ...
                                <a href="tel:{{ $config->cell_phone }}" class="hover:text-white transition-colors">{{ $config->phone }}</a>
                            </li>
                        @endif
                        @if($config->whatsapp)
                            <li class="flex items-center gap-3">
                                ...
                                <a href="tel:{{ $config->whatsapp }}" class="hover:text-white transition-colors">{{ $config->phone }}</a>
                            </li>
                        @endif
                        @if($config->email)
                            <li class="flex items-center gap-3">
                        ...
                        @if($config->additional_email)
                            <li class="flex items-center gap-3">
                                ...
                                <a href="mailto:{{ $config->additional_email }}" class="hover:text-white transition-colors">{{ $config->email }}</a>
                            </li>
                        @endif
                    </ul>
                </div>
                ...
                <div class="p-5 rounded-2xl border backdrop-blur-sm"
                    ...
                    <form class="flex gap-2">
                        <input type="email" placeholder="seu@email.com" required
                            class="flex-1 px-3 py-2 text-sm rounded-lg border outline-none transition-all focus:border-[#6ba3c8]"
                            style="background: rgba(10,25,41,0.6); border-color: rgba(107,163,200,0.25); color: #e8f0f8;">
                        <button type="submit"
